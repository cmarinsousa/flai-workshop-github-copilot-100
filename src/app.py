...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team and compete in interschool matches",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if email in activity["participants"]:
        raise HTTPException(status_code=400, detail="Student already signed up") # Validate activity is not full if len(activity["participants"]) >= activity["max_participants"]: raise HTTPException(status_code=400, detail="Activity is full")
